...
anlyFileBtn = tk.Button(frame, text="Analyse File", padx=15, pady=10, fg="#000000", bg="#CF6679", command=analyse_ticker_file)
...
anlyTickerBtn = tk.Button(frame, text="Analyse Ticker", padx=15, pady=10, fg="#000000", bg="#CF6679", command=analyse_ticker_input)
